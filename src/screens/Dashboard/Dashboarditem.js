...
function DashboardItem() {
  ...
  return (
    <div className="container mx-auto p-6 min-h-screen text-black bg-gray-100">
      ...
      <form className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8" onSubmit={handleNewRowSubmit}>
        <input
          type="text"
        ...
        <button
          type="submit"
          className="bg-blue-600 text-white p-2 rounded w-full mt-2 col-span-1 md:col-span-2"
        >
          Add Row
        </button>
      </form>
