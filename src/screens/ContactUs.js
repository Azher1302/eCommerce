...
function ContactUs() {
  const contactData = [
    ...
    },
    {
      ...
      icon: faMapMarkerAlt,
      contact: '46/2769-F, Second Floor, SA Plaza, Vivekananda Rd, Vennala, Kochi, Kerala 682028',
    },
  ];
  ...
  return (
    <Layout>
      <div className="min-h-screen bg-gray-100 container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:grid-cols-3 xl:gap-10">
          {contactData.map((data) => (
            <div key={data.id} className="bg-white shadow-lg rounded-lg p-8 text-center">
              ...
              <p className="mb-4 text-base text-gray-600">
                {data.contact ? (
                  <a href={`mailto:${data.contact}`} className="text-indigo-600">
                    {data.contact}
                  </a>
                ) : null}{' '}
                {data.info}
