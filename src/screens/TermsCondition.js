        ...
        <div className="bg-white my-12">
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                These conditions outline the rules and regulations for
                the use of EcommerSio Market's Website. By accessing this
                website we assume you accept these conditions. Do not
                continue to use EcommerSio Market if you do not agree to take
                all of the conditions stated on this page.
              </p>
              <p>
                The following terminology applies to these Conditions,
                Privacy Statement and Disclaimer Notice and all Agreements:
                "Client", "You" and "Your" refers to you, the person log on this
                website and compliant to the Company’s conditions.
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                ...
                Our Conditions were created with the help of the Terms
            ...
            <div className="my-6 lg:my-8 last:mb-0">
              ...
              <div className="font-sans leading-7">
                <p>
                  ...
                  the right to amen these conditions and it’s linking
