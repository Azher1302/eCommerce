...
//   const handleLoadMore = () => {
//     setCurrentPage(prevPage => prevPage + maxItemsPerPage);
//   };
...
//     } else {
//       setSearchResults(filteredProducts); // Reset to filtered products if no query
//     }
//   };

//   const displayedProducts = searchResults.length > 0 ? searchResults : filteredProducts.slice(0, currentPage);
